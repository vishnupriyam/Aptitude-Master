...
namespace Aptitude_Master
{
    ...
    public sealed partial class Test : Page
    {
        ...
        {
            int count = 0;
            if (q1o1.IsChecked == true)
            {
                count++;
            }
            if (q2o4.IsChecked == true)
            {
                count++;
            }
            if (q3o4.IsChecked == true)
            {
                count++;
            }
            if (q4o2.IsChecked == true)
            {
                count++;
            }
            ...
            if (q6o1.IsChecked == true)
            {
                count++;
            }
            if (q7o4.IsChecked == true)
            {
                count++;
            }
            if (q8o3.IsChecked == true)
            {
                count++;
            }
            if (q9o1.IsChecked == true)
            {
                count++;
            }
            ...
            if (count >= 6)
            {
                new Windows.UI.Popups.MessageDialog("You are qualified for next round").ShowAsync();
                this.Frame.Navigate(typeof(Test2));
            }
            else
            {
                new Windows.UI.Popups.MessageDialog("You are not qualified for next round.Please retake the test").ShowAsync();
